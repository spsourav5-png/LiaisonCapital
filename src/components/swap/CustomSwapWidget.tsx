...
export default function CustomSwapWidget() {
  // Transit Finance Web Widget URL targeting Ethereum and LIA
  const transitWidgetUrl = 'https://swap.transit.finance/?chain=ethereum&to=0xdb49FBb3CE99b2f7aA237BE400200f67B5bd3F52';
